...
$(document).ready(function () {
  ...
  // const warningTitleCSS = 'color:red; font-size:60px; font-weight:  bold; font-family:helvetica; -webkit-text-stroke: 1px black;';
  // const warningDescCSS = 'font-size: 18px;';
  //
  // console.log('%cStop!', warningTitleCSS);
  // console.log("%cThis is a browser feature intended for developers!. If someone told you to copy-paste something here to enable a Autocredit feature or \"hack\" someone's account, it is a scam and will give them access to your Autocredit account.", warningDescCSS);
